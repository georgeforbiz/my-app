...
const translations: Record<Locale, TranslationBundle> = {
  ...
  hy: {
    ...
    heroEyebrow: "",
    heroTitleBefore: "Վերջ տուր բանավոր պայմանավորվածություններին:",
    heroTitleHighlight: "",
    heroTitleAfter: "Պաշտպանիր գործարքդ նախքան սկսելը:",
    heroSubtitle: "Ուղարկիր հղումը: Ֆիքսիր պայմանները:\nԽուսափիր վեճից:",
    heroPainPoints: [
